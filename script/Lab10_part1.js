...
function changeBg(){
    if(document.getElementById("colorsel").value == 'red')
    {
        document.getElementById("td_text").style.backgroundColor = 'red';
    }
    if(document.getElementById("colorsel").value == 'green')
    {
        document.getElementById("td_text").style.backgroundColor = 'green';
    }
    if(document.getElementById("colorsel").value == 'blue')
    {
        document.getElementById("td_text").style.backgroundColor = 'blue';
    }
    if(document.getElementById("colorsel").value == 'nothing')
    {
        document.getElementById("td_text").style.backgroundColor = 'transparent';
    }
}
